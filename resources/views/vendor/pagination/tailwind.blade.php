@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden" style="margin-left: 23px;">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5" style="margin-left: 23px;font-weight: 700;margin-top: 20px;">
            ...
            <div>
                <span class="relative z-0 inline-flex shadow-sm rounded-md" style="margin-left: 23px;">
