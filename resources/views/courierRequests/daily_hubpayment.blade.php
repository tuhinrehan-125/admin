                    ...
                    <tbody>
                        @foreach($courier_requests as $courier_request)
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ date('d-m-Y h:i A',strtotime($courier_request->created_at)) }}<br>

                                </td>
                                <td>
                                    {{ !empty($courier_request->delivery_date)?date('d-m-Y h:i A',strtotime($courier_request->delivery_date)):"Not Available" }}<br>
        ...
        $(document).ready(function() {
           ...
           dataTable();
            $('#btnSearch').click(function(){
                ...
                if(sdate != "" && stime != "" && edate != "" && etime != "" && merchantname != "" ){
                ...
                $.ajax({
                    url: "{{ route('dashboard.search.daily_hub_payment.accounts') }}",
                    method: 'GET',
                    data: dataobj,
                    dataType:'json',
