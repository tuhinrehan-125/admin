...
@section('page-content')
    <div class="card mt-5" style="width: 100%;">
        ...
        <form action="{{ route('dashboard.courier.rider.delivery.payment.request') }}" method="post">
        @csrf 
          ...
          <div class="panel-heading">
            <div class="row"> 
              <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <select name="delivery_rider_commission_payment" class="form-control">
        ...
        <div class="card-body">
            <p class="text-bold" style="background:#dee2e6; padding: 1.2em;">Delivery Rider Courier Requests Table</p>
            @if(session('message'))
                ...
                <table id="example" class="display table table-bordered" style="width:100%">
                    ...
                    <tbody>
                        @foreach($courier_requests as $courier_request)
                            ...
                            <tr @if($courier_request->delivery_rider_commission_payment == "yes") style="background: #8fc38f;" @endif>
                                <td> <input type="checkbox" name="ids[]" value="{{$courier_request->id}}" @if($courier_request->delivery_rider_commission_payment == "yes") disabled @endif></td>
                                <td>
                                ...
                                <td>
                                    Commission Amount: {{!empty($courier_request->delivery_rider_commission)?$courier_request->delivery_rider_commission:"0"}} <br>
                                    @if($courier_request->delivery_rider_commission > 0)
                                        Commission Paid : {{!empty($courier_request->delivery_rider_commission_payment)?$courier_request->delivery_rider_commission_payment:"Not Available"}}
                                    @endif
                                </td>
